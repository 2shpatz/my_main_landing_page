        ...
        columns: [
          {
            ...
            priceUnit: 'לתמיד',
            items: [
              'הזנה ידנית של יומני שינה, עריכה ומחיקה',
              'כל התרשימים והמדדים, כולל מדד ההתקדמות',
              'ייבוא וייצוא Excel, כולל תבנית יומן ריקה',
              'סנכרון יומן מגיליון Google Sheets',
              'חילוץ בעזרת AI — גם מקומי (Ollama) וגם Gemini',
              'מסלול הדרכת ההורים במלואו: מפגשים, חילוץ, אצירת נושאים, טיפים ומשימות',
              'גיבוי ושחזור',
            ],
          },
          {
